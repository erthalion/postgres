...
static void log_undo_smgr_create(xu_smgr_create *undo_rec, bool needs_wal);
...
RelationCreateStorage(RelFileNode rnode, char relpersistence)
{
	...
	if (!IsBootstrapProcessingMode())
	{
		...
		log_undo_smgr_create(&undo_rec, needs_wal);
	}
 ...
 */
static void
log_undo_smgr_create(xu_smgr_create *undo_rec, bool needs_wal)
{
