...
typedef SubscriptingRef * (*SubscriptingFetch) (Datum source, struct SubscriptingRefState *sbsefstate);

typedef SubscriptingRef * (*SubscriptingAssign) (Datum source, struct SubscriptingRefState *sbsefstate);
